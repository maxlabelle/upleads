          ...
          <div class="col-md-12">
            <div class="card">
              ...
              <div class="card-body">
                ...
                <div class="form-group">
                  <label>Order confirmation tracking tag</label>
                  <div class="input-group mb-3">
                    <input type="text" disabled="disabled" readonly value='<script src="<?=base_url()?>/o/<?=(!empty($campaign)) ? $campaign->tracking_tag_id : ''?>"></script>' class="form-control" id="content" placeholder="URL" aria-label="URL" aria-describedby="button-addon2">
                    <div class="input-group-append">
                      <button class="btn btn-outline-secondary copy-text" type="button" id="button-addon2">Copy</button>
                    </div>
                  </div>
