          ...
          <div class="col-lg-12">
            ...
            <div class="card mt-4">
              <div class="card-header">
                <h5 class="card-title m-0">Upleads Affiliate Marketing & Tracking Software</h5>
              </div>
              <div class="card-body">
                <div class="jumbotron bg-gradient-light" style="color:#666;">
                  <h1 class="display-4">Upleads is free & open-source (FOSS)!</h1>
